<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"./template/pc/rainbow/goods\goodsInfo.html";i:1540260094;s:61:"D:\phpStudy\WWW\TPshop\template\pc\rainbow\public\header.html";i:1540260094;s:74:"D:\phpStudy\WWW\TPshop\template\pc\rainbow\goods\goodsInfoCombination.html";i:1540260094;s:69:"D:\phpStudy\WWW\TPshop\template\pc\rainbow\goods\goodsInfoDetail.html";i:1540260094;s:61:"D:\phpStudy\WWW\TPshop\template\pc\rainbow\public\footer.html";i:1540260094;s:67:"D:\phpStudy\WWW\TPshop\template\pc\rainbow\public\sidebar_cart.html";i:1540260094;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
					...
					<div class="item">
						...
						<div class="cata-nav-layer">
							...
							<div class="advertisement_down">
								<?php $pid =100+$kr;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1555747200 and end_time > 1555747200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
...
foreach($result as $key=>$v3):       
    ...
    ?>
							...
							<?php $pid =51;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1555747200 and end_time > 1555747200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
    ...
    <div class="w1224">
        ...
        <form id="buy_goods_form" name="buy_goods_form" method="post" action="">
            ...
            <div class="detail-ggsl">
                ...
                <p class="detail-ggsl-p" ><a href=""><?php echo $goods['goods_remark']; ?></a></p>
                ...
                <div class="shop-price-cou p">
                    ...
                    <div class="shop-cou-ri">
                        <div class="allcomm"><p>累计评价</p>
                            <p class="f_blue"><?php echo $goods['comment_count']; ?></p></div>
                        <div class="br1"></div>
...
<div style="display: none" id="look_see">
    <?php
                                ...
                                {                            
                                    ...
                                    S("sql_".$md5_key,$sql_result_look,1);
                                }    
