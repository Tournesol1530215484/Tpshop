<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/plugin\index.html";i:1540260088;s:64:"D:\phpStudy\WWW\TPshop\application\admin\view\public\layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a data-href="#tab_debug"  id="tab_base_debug" class="<?php if($type == 'debug'): ?>current<?php endif; ?>tab"><span>调试</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
    ...
    <div class="flexigrid">
        ...
        <!--功能插件-->
        <!--调试-->
        <div class="bDiv" id="tab_debug" style="height: auto;<?php if($type != 'debug'): ?>display: none;<?php endif; ?>">
              <form action="<?php echo U('admin/plugin/debug_switch'); ?>" id="handlepost1" name="handlepost1" method="post">
		        <div class="ncap-form-default">
		            <dl class="row">
		                <dt class="tit">微商城分享调试</dt>
		                <dd class="opt">
		                    <div class="onoff">
		                        <label for="wx_share_debug1" class="cb-enable <?php if($config[wx_share_debug] == 1): ?>selected<?php endif; ?>">开启</label>
		                        <label for="wx_share_debug0" class="cb-disable <?php if($config[wx_share_debug] == 0): ?>selected<?php endif; ?>">关闭</label>
		                        <input id="wx_share_debug1" name="wx_share_debug" <?php if($config['wx_share_debug'] == 1): ?>checked="checked"<?php endif; ?> value="1" type="radio">
		                        <input id="wx_share_debug0" name="wx_share_debug" <?php if($config['wx_share_debug'] == 0): ?>checked="checked"<?php endif; ?> value="0" type="radio">
		                    </div>
		            ...
		            <dl class="row">
		                ...
		                <dd class="opt">
		                    <div class="onoff">
		                        <label for="wx_mp_pay_debug1" class="cb-enable <?php if($config[wx_mp_pay_debug] == 1): ?>selected<?php endif; ?>">开启</label>
		                        <label for="wx_mp_pay_debug0" class="cb-disable <?php if($config[wx_mp_pay_debug] == 0): ?>selected<?php endif; ?>">关闭</label>
		                        <input id="wx_mp_pay_debug1" name="wx_mp_pay_debug" <?php if($config['wx_mp_pay_debug'] == 1): ?>checked="checked"<?php endif; ?> value="1" type="radio">
		                        <input id="wx_mp_pay_debug0" name="wx_mp_pay_debug" <?php if($config['wx_share_debug'] == 0): ?>checked="checked"<?php endif; ?> value="0" type="radio">
		                    </div>
